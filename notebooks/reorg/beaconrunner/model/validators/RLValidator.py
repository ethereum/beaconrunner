...
class RLValidator(BRValidator):
    ...
    validator_behaviour = "rl"

    def attest(self, known_items, params=None) -> Optional[Attestation]:
        """
    ...
    def sync_committees(self, known_items, params=None) -> Optional[Sequence[SyncCommitteeBundle]]:
        """
