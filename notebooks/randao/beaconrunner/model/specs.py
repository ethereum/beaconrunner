...
TARGET_AGGREGATORS_PER_SYNC_SUBCOMMITTEE = 2
SYNC_COMMITTEE_SUBNET_COUNT = 2
...
SLOTS_PER_HISTORICAL_ROOT = uint64(128)
EPOCHS_PER_HISTORICAL_VECTOR = uint64(128)
EPOCHS_PER_SLASHINGS_VECTOR = uint64(128)
HISTORICAL_ROOTS_LIMIT = uint64(1024)
VALIDATOR_REGISTRY_LIMIT = uint64(128)
...
def get_next_sync_committee(state: BeaconState) -> SyncCommittee:
    ...
    return SyncCommittee(pubkeys=pubkeys, aggregate_pubkey=BLSPubkey())
...
def upgrade_to_altair(pre: BeaconState) -> BeaconState:
